  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-solid btn-primary">Save changes</button>
      </div>
    </div>
  </div>
</div>
...
<!-- Modal Themes -->
<div class="modal fade modal-primary" id= "primaryModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Modal title</h5>
...
<div class="modal fade modal-success" id= "successModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-solid btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-solid btn-success">Save changes</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade modal-warning" id= "warningModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-solid btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-solid btn-warning">Save changes</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade modal-danger" id= "dangerModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Modal title</h5>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-solid btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-solid btn-danger">Save changes</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade modal-info" id= "infoModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-solid btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-solid btn-info">Save changes</button>
      </div>
    </div>
  </div>
</div>