<div class= "p-4 my-5 mr-4 border rounded shadow-sm content bg-light" id= "card-page">
            ...
            <div class= "row">
                <div class= "col-md-4 mb-5">
                    <div class="card card-outline">
                        <div class="card-body">
                            <h5 class="card-title">.card-outline</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                    </div>
                </div>
    ...
    <div class= "card mb-5">
        <div class= "card-header">Card - Accent</div>
        <div class= "card-body">
            <div class= "row">
                <div class= "col-md-4 mb-5">
                    <div class="card card-accent">
                        <div class="card-body">
                            <h5 class="card-title">.card-accent</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                    </div>
                </div>
                <div class= "col-md-12">
                    ...
                    <div class= "row">
                        ...
                        <div class= "col-md-4 mb-3">
                            <div class="card card-accent card-secondary">
                                <div class="card-body">
                                    <h5 class="card-title">.card-secondary</h5>
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                </div>
                        ...
                        <div class= "col-md-4 mb-3">
                            <div class="card card-accent card-info">
                                <div class="card-body">
                                    <h5 class="card-title">.card-info</h5>
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                </div>
                        ...
                        <div class= "col-md-4 mb-3">
                            <div class="card card-accent card-light">
                                <div class="card-body">
                                    <h5 class="card-title">.card-light</h5>
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                </div>
                        ...
                        <div class= "col-md-4 mb-3">
                            <div class="card card-accent card-dark">
                                <div class="card-body">
                                    <h5 class="card-title">.card-dark</h5>
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                </div>
    ...
    <div class= "card mb-5">
        <div class= "card-header">Card - With Header</div>
        <div class= "card-body">
            <div class= "row">
                <div class= "col-md-4 mb-5">
                    <div class="card card-primary">
