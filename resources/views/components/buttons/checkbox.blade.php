<div class= "px-5 mt-5 content" id= "checkbox-page">
    ...
    <div class= "row mt-3 mb-5">
        ...
        <div class= "col-lg-6 py-3 col-12">
            ...
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;< <span class= "text-danger">label</span> for= "<span class= "text-danger">checkbox-default</span>" ></p>
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;< <span class= "text-danger">i</span> class= "<span class= "text-danger">fas fa-check align-middle</span>" >< <span class= "text-danger">/i</span> ></p>
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;< <span class= "text-danger">p</span> >Normal checkbox< <span class= "text-danger">/p</span> ></p>
    ...
    <div class= "row mt-3 mb-5">
        ...
        <div class= "col-lg-6 py-3 col-12">
            ...
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;< <span class= "text-danger">label</span> for="<span class= "text-danger">checkbox-rounded</span>" ></p>
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;< <span class= "text-danger">span</span>>< <span class= "text-danger">/span</span> ></p>
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;< <span class= "text-danger">p</span> >Rounded checkbox< <span class= "text-danger">/p</span> ></p>
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;< <span class= "text-danger">/label</span> ></p>
            <p class= "mb-1">< <span class= "text-danger">/div</span> ></p>
            <p id= "note" class= "text-warning"><i class= "fas fa-info-circle"></i>Just remove the spaces when you copy it!</p>
        </div>
    ...
    <div class= "row mt-3 mb-5">
        <div class="col-lg-6 py-3 agm-bg-light rounded col-12">
            ...
            <div class= "form-checkbox checkbox-animated">
                ...
                <label for= "checkbox-animated">
                    <svg viewBox= "0 0 18 18">
                        <path d= "M1,9 L1,3.5 C1,2 2,1 3.5,1 L14.5,1 C16,1 17,2 17,3.5 L17,14.5 C17,16 16,17 14.5,17 L3.5,17 C2,17 1,16 1,14.5 L1,9 Z"></path>
                        <polyline points= "1 9 7 14 15 4"></polyline>
                    </svg>
                    <p>Animated checkbox</p>
                </label>
            </div>
        </div>
        <div class= "col-lg-6 py-3 col-12">
            ...
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;< <span class= "text-danger">label</span> for="<span class= "text-danger">checkbox-animated</span>" ></p>
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;< <span class= "text-danger">svg</span> viewBox= "<span class= "text-danger">0 0 18 18</span>" >< <span class= "text-danger">/svg</span> ></p>
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;< <span class= "text-danger">p</span> >Animated checkbox< <span class= "text-danger">/p</span> ></p>
            <p class= "mb-1">&nbsp;&nbsp;&nbsp;< <span class= "text-danger">/label</span> ></p>
            <p class= "mb-1">< <span class= "text-danger">/div</span> ></p>
            <p id= "note" class= "text-warning"><i class= "fas fa-info-circle"></i>Just remove the spaces when you copy it!</p>
        </div>
