    ...
    <div class= "row my-3">
        ...
        <div class= "col-md-4 mb-3">
            <div class="card card-accent-primary">
                <div class="card-body">
                    <h5 class="card-title">Accent Card title - Primary</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-accent-secondary">
                <div class="card-body">
                    <h5 class="card-title">Accent Card title - Secondary</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-accent-success">
                <div class="card-body">
                    <h5 class="card-title">Accent Card title - Success</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-accent-warning">
                <div class="card-body">
                    <h5 class="card-title">Accent Card title - Warning</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-accent-danger">
                <div class="card-body">
                    <h5 class="card-title">Accent Card title - Danger</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-accent-info">
                <div class="card-body">
                    <h5 class="card-title">Accent Card title - Info</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-accent-light">
                <div class="card-body">
                    <h5 class="card-title">Accent Card title - Light</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-accent-dark">
                <div class="card-body">
                    <h5 class="card-title">Accent Card title - Dark</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
    ...
    <div class= "row my-3">
        ...
        <div class= "col-md-4 mb-3">
            <div class="card card-outline-primary">
                <div class="card-body">
                    <h5 class="card-title">Outline Card title - Primary</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-outline-secondary">
                <div class="card-body">
                    <h5 class="card-title">Outline Card title - Secondary</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-outline-success">
                <div class="card-body">
                    <h5 class="card-title">Outline Card title - Success</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-outline-warning">
                <div class="card-body">
                    <h5 class="card-title">Outline Card title - Warning</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-outline-danger">
                <div class="card-body">
                    <h5 class="card-title">Outline Card title - Danger</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-outline-info">
                <div class="card-body">
                    <h5 class="card-title">Outline Card title - Info</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-outline-light">
                <div class="card-body">
                    <h5 class="card-title">Outline Card title - Light</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
        <div class= "col-md-4 mb-3">
            <div class="card  card-outline-dark">
                <div class="card-body">
                    <h5 class="card-title">Outline Card title - Dark</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
